...
export default function Terms() {
  return (
    <>
      <div className='mx-auto max-w-[328px] lg:max-w-4xl pb-10'>
      <div className='mt-8 flex justify-center text-[20px] lg:mt-5 lg:text-[32px]'>
        Terms & Conditions
      </div>
      <ul className='mt-6 flex list-disc flex-col items-start justify-start gap-y-4 text-justify text-sm font-light lg:mx-auto lg:mt-7.5 lg:text-[16px]'>
        {terms.map((val, idx) => (
          <li
            key={idx}
            className='pl-px [-text-indent:1.25rem]'
          >
            {val}
          </li>
        ))}
